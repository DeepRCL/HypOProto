...
NAME="Hyper_Proto_Dino_512_5e-4PP_LR_Push_10_00"
SAVE_DIR="logs/"$NAME

python main.py --seed=16 --config_path=$CONFIG_YML --save_dir=$SAVE_DIR --run_name=$NAME --log_level="ERROR" 2>&1 | grep -v "GetObject.*object_info"

#### TEST ######
python main.py --seed=16 --config_path=$CONFIG_YML --save_dir=$SAVE_DIR --run_name="Test/"$NAME --eval_only=True\
        --eval_data_type='test'  --model.checkpoint_path=$SAVE_DIR"/model_best.pth" --wandb_mode="disabled"