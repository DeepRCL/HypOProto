...
class XProtoNet_e2e(XProtoNet_Base):
    ...
    def get_optimizer(self):
        ...
        if optimizer_mode == "lr_same":
        ...
        elif optimizer_mode == "lr_ee":
            proto_params = []
            pas_params = []
            other_params = []

            for name, param in self.model.named_parameters():
                if "prototype_ee" in name:
            ...
            optimizer_specs = [
                ...
                {
                    "params": proto_params,
                    "lr": config['lr_ee'],   # ← much larger LR for EE / radii
                    "weight_decay": 1e-1,              # ← usually better for scalar radii
                },
                # {
                #     "params": self.model.prototype_vectors,
                #     "lr": config["lr_prototype_vectors"],
                # },
            ]
