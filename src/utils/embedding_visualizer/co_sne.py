...
from src.utils.embedding_visualizer.pvae.manifolds.poincareball import PoincareBall
...
def run_TSNE(embeddings, learning_rate=1.0, learning_rate_for_h_loss=0.0, perplexity=5, early_exaggeration=1,
             student_t_gamma=1.0):
    tsne = TSNE(n_components=2, method='exact', perplexity=perplexity, learning_rate=learning_rate,
    ...
    co_sne = hTSNE(n_components=2, verbose=0, method='exact', square_distances=True,
                   ...
                   student_t_gamma=student_t_gamma, learning_rate=learning_rate, n_iter=1000, perplexity=perplexity,
    ...
    _htsne = hTSNE(n_components=2, verbose=0, method='exact', square_distances=True,
                   metric='precomputed', learning_rate_for_h_loss=0.0, student_t_gamma=1.0, learning_rate=learning_rate,
...
def plot_low_dims(tsne_embeddings, HT_SNE_embeddings, CO_SNE_embedding, colors, learning_rate, learning_rate_for_h_loss,
...
if __name__ == "__main__":
    ...
    tsne_embeddings, HT_SNE_embeddings, CO_SNE_embedding = run_TSNE(embeddings, learning_rate, learning_rate_for_h_loss,
                                                                    perplexity, early_exaggeration, student_t_gamma)

    plot_low_dims(tsne_embeddings, HT_SNE_embeddings, CO_SNE_embedding, colors, learning_rate, learning_rate_for_h_loss,
                  perplexity, early_exaggeration, student_t_gamma)