...
import src.utils.embedding_visualizer.geom.euclidean as euclidean
import src.utils.embedding_visualizer.geom.hyperboloid as hyperboloid
import src.utils.embedding_visualizer.geom.minkowski as minkowski
import src.utils.embedding_visualizer.geom.poincare as poincare
from src.utils.embedding_visualizer.geom.horo import busemann, project_kd
from src.utils.embedding_visualizer.utils.metrics import compute_metrics
...
class PCA(ABC, nn.Module):
    ...
    def fit_optim(self, x, iterative=False):
        ...
        if not iterative:
            for i in tqdm(range(self.max_steps), desc='Optimizing HoroPCA'):
            ...
            for k in tqdm(range(self.n_components), desc='Optimizing HoroPCA iteratively'):
